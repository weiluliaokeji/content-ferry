...
- 章节标题与要点用作者自己的判断组织，避免“首先/其次/最后”“三大维度”等机械分点与空泛拔高，不写“本文将深入探讨”之类的元话术。
...
目标：
- 降低套路化、模板化和机械分点的表达，让文章更像有真实判断与经验的作者所写；具体对照所注入技能列出的去 AIGC 模式（开场套话、空总结、渲染性强调、商业黑话、工程师腔、自媒体流水线语气、伪洞见骨架、机械结构等），逐项清除；
