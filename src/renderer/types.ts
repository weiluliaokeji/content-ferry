...
export type MediaAccount = { id: string; platform: AccountPlatform; displayName: string; externalAccountId: string | null; credentialsConfigured: boolean; profile: AccountProfile; cnblogsCategories: string[]; cnblogsTags: string[]; fiftyoneCtoPidOptions: Array<{ value: string; label: string }>; fiftyoneCtoCateOptions: Array<{ value: string; label: string }> };
