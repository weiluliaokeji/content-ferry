    ...
    <div className="help-center">
      ...
      <section className="card help-faq">
        ...
        <details>
          ...
          <p>工作台已有资料的文章会显示“查看资料”和“继续补研”；在“第三步：补充资料”中，可以让阿文继续联网核查，也可只新增指定资料链接。资料窗口会显示本次问题、证据维度、时效/冲突提醒、已覆盖材料和缺口；快速核实、均衡调研、深入研究只改变执行预算，预算耗尽或仍有缺口时会明确显示“部分调研”，可直接围绕缺口继续补研。指定链接会单独显示待人工核验、已人工核验、不采用或无法访问状态；未核验前不会作为写作依据。若已掌握可靠内容，可以填写“手工补录资料卡”；链接与指定资料一致时，这条摘要会成为它的核验结果，保存后资料卡才会默认作为后续提纲和正文的资料依据。补研等待较久时可点“暂停补研”，稍后再点“继续补研”；也可停止本轮任务。已保存的资料卡不会丢失；如果应用中途重启，重新打开资料窗口会自动接管排队或已失联的补研任务。</p>
        </details>
        <details>
