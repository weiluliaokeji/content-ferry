    ...
    <div className="help-center">
      ...
      <section className="card help-faq">
        ...
        <details>
          ...
          <p>在文章编辑页的“文章设置”中可勾选申请原创声明、开启赞赏，或填写合集名称。新建文章时，“作者”默认填为最近使用过的作者，“申请原创声明”与“开启赞赏”默认已勾选，可按需取消。草稿创建后，在发布中心点击“在微信后台完善并发布”；文渡会先读取微信“选择合集”窗口中可见的名称，按公众号缓存后再匹配文章设置。下次可直接从同一公众号的下拉建议中选择；微信后台仍是最终来源。你仍要核对最终效果，并在微信后台点击发布。</p>
        </details>
        <details>
