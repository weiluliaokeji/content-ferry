...
export function LibraryView(props: LibraryViewProps) {
  ...
  return <section className="card">
    <div className="section-heading"><div className="library-intro"><p className="hint compact-hint">已归档的文章只供查阅。可通过「重新发布」在工作台重新打开发布流程。</p>{sourcePreview && <p className="hint compact-hint">已连接 {sourcePreview.rootPath}。</p>}</div><button onClick={() => void openSource()}>配置并扫描</button></div>
