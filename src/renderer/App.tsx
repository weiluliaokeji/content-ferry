...
export function App() {
  ...
  return <div className={`app-shell${sidebarCollapsed ? " sidebar-collapsed" : ""}`}>
    ...
    {titleEditProject && <Modal priority className="title-edit-modal" onClose={closeTitleEdit} disabled={titleEditSuggesting} title="修改文章标题" eyebrow="第三步：补充资料">
    ...
    {practicePlanProject && <Modal className="outline-modal" onClose={() => { if (!practicePlanBusy) cancelPracticePlanGeneration(); }} disabled={practicePlanBusy} title={`最小实践计划：${practicePlanProject.topic}`} eyebrow="正文起草前" wide>
