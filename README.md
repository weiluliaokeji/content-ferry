...
- **创作与发布解耦**：无论文章在哪写成，最后都由文渡处理微信公众号、CSDN、博客园、51CTO 等渠道的改写、封面、AIGC 检测与发布。

简言之：**文章在你自己的文件里写，文渡只做“最后一公里”的发布。**

## 已实现的主要能力

- 管理多个微信公众号、CSDN、博客园或 51CTO 账号，并保存账号定位、目标读者、写作风格、禁用话题和常用栏目。
...
| AI       | 文渡模型适配层与可编辑技能                                                             |
| 发布     | 微信公众号官方 API、回调与必要的浏览器自动化；博客园 MetaWeblog XML-RPC（API Key）直发；51CTO Cookie/API 发布 |
